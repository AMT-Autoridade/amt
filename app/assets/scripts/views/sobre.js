        ...
        <section id='sobre' className='content-wrapper'>
          ...
          <div className="wrapper">
            <div>
              ...
              <p>Este microsite é baseado no Relatório Estatístico - <strong><a href={`${config.api}/master/files/amt-servico-transporte-taxis.pdf`} title='Descarregar Relatório'>Serviços de Transporte em Táxi: A realidade atual e a evolução na última década</a></strong>. A recolha estatística apresentada visa dar a conhecer factos essenciais sobre as condições de prestação de serviços de táxi em Portugal, constituindo mais um contributo da AMT para a reflexão sobre o quadro legislativo e regulatório no transporte de passageiros em veículos ligeiros. Potenciam-se assim decisões informadas e adequadas aos interesses dos utilizadores destes serviços e possibilita-se um acompanhamento dos efeitos das opções que venham a ser tomadas.</p>
            </div>
            <div>
