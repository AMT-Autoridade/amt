        ...
        <section id='sobre' className='content-wrapper'>
          ...
          <div className='wrapper'>
            <div>
              ...
              <p>Para mais informações, pode ser consultado o documento - <strong><a href="http://amt-autoridade.pt/media/2558/sintese-mercado-taxi-portugal-junho2020.pdf" title='Descarregar Documento' target="_blank">O Transporte em Taxi em Portugal</a></strong>. A recolha estatística apresentada visa dar a conhecer factos essenciais sobre as condições de prestação de serviços de táxi em Portugal, constituindo mais um contributo da AMT para a reflexão sobre o quadro legislativo e regulatório no transporte de passageiros em veículos ligeiros. Potenciam-se assim decisões informadas e adequadas aos interesses dos utilizadores destes serviços e possibilita-se um acompanhamento dos efeitos das opções que venham a ser tomadas.</p>
            </div>
            <div>
              <h3>Informações e Contactos</h3>
              <p>Este projeto foi coordenado pelo Observatório do Ecossistema da Mobilidade e dos Transportes. Para mais informações contactar <a href='mailto:observatorio@amt-autoridade.pt
'>observatorio@amt-autoridade.pt</a>.</p>
