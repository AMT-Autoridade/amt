...
var SectionMobilidade = React.createClass({
  ...
  renderEvolutionChart: function () {
    ...
    return <BarChart data={chartData} options={chartOptions} height={280} ref={this.addChartRef('chart-evolution')}/>;
  },
  ...
  renderLicencasChart: function () {
    ...
    return <PieChart data={chartData} options={chartOptions} height={280} ref={this.addChartRef('chart-lic')}/>;
  },
